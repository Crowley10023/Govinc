 ...
 * - ASSESSOR: Can answer questions, use guide and write comments in assigned assessments
 */
public enum Role {
    ...
    ORGANISATION_TEAM_LEADER("Organisation Team Leader", "Access to organization units and their assessments"),
     ...
     ASSESSOR("Assessor", "Can answer questions, use guide, and write comments in assigned assessments");
